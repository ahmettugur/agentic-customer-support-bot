...
namespace CustomerSupportBot.Adapters.Persistence.Migrations
{
    ...
    [Migration("20260824184110_AddApprovalParamSignatureDedup")]
    partial class AddApprovalParamSignatureDedup
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CustomerSupportBot.Adapters.Persistence.EfCore.Entities.Hitl.ApprovalRequestEntity", b =>
                {
                    ...
                    b.Property<string>("ParamSignature")
                        .HasMaxLength(1000)
                    ...
                    b.HasIndex("Status", "ExecutionStatus")
                    ...
                    b.HasIndex("SessionId", "ToolName", "ParamSignature")
                        .IsUnique()
