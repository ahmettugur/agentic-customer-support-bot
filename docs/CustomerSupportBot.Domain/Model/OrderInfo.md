...
- [../../CustomerSupportBot.Adapters.Persistence/Postgres/OrderRepository.md](../../CustomerSupportBot.Adapters.Persistence/Postgres/OrderRepository.md) — `OrderRepository` ve `order_details` eşlemesi
