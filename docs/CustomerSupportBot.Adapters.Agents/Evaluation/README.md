...
> 💡 **Analiz notu:** Otomatik test sistemi — evaluation-scenarios.yaml'daki senaryoları gerçek bot üzerinde çalıştırır ve "doğru yanıt verdi mi?" diye puanlar. Regression testi gibi ama LLM yanıtları için.
