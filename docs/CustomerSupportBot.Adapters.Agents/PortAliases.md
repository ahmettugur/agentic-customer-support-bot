...
> 💡 **Analiz notu:** `global using` ile proje genelinde uzun namespace'leri kısaltır. Her dosyada `using CustomerSupportBot.Application.Ports.Outbound;` yazmak yerine bir kez burada tanımlarsın.
