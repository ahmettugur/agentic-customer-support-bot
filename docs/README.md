...
| [Api/A2A.md](CustomerSupportBot.Api/Endpoints/A2A.md) | A2A (Agent2Agent) — ajanların dış sistemlere açılması, iki adımlı token, AgentCard keşfi, başka dillerden entegrasyon |
